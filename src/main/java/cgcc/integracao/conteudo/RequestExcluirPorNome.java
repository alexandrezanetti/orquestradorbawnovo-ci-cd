...
/**
 * Contempla as informações a serem enviadas na requisição de exclusão de conteúdo, através de seu nome, no repositório GCC
 */
@ApiModel(description = "Contempla as informações a serem enviadas na requisição de exclusão de conteúdo, através de seu nome, no repositório GCC")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-06-02T20:33:16.213Z")
public class RequestExcluirPorNome {
  ...
  public RequestExcluirPorNome centroCusto(String centroCusto) {
  ...
  **/
  ...
  public RequestExcluirPorNome canal(String canal) {
    this.canal = canal;
    return this;
  }
  ...
  **/
  ...
  public RequestExcluirPorNome usuario(String usuario) {
  ...
  **/
  ...
  public RequestExcluirPorNome senha(String senha) {
    this.senha = senha;
    return this;
  }
  ...
  **/
  ...
  public RequestExcluirPorNome objectStore(String objectStore) {
  ...
  **/
  ...
  public RequestExcluirPorNome nome(String nome) {
    this.nome = nome;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RequestExcluirPorNome requestExcluirPorNome = (RequestExcluirPorNome) o;
    return Objects.equals(this.centroCusto, requestExcluirPorNome.centroCusto) &&
        Objects.equals(this.canal, requestExcluirPorNome.canal) &&
        Objects.equals(this.usuario, requestExcluirPorNome.usuario) &&
        Objects.equals(this.senha, requestExcluirPorNome.senha) &&
        Objects.equals(this.objectStore, requestExcluirPorNome.objectStore) &&
        Objects.equals(this.nome, requestExcluirPorNome.nome);
  }

  @Override
  public int hashCode() {
    return Objects.hash(centroCusto, canal, usuario, senha, objectStore, nome);
  }
  ...
  public String toString() {
    ...
    sb.append("class RequestExcluirPorNome {\n");
